  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Vessel Management</h2>
          <p className="text-sm sm:text-base text-gray-600">Manage fleet vessels and configurations</p>
        </div>
